...
title_size	|length	|Required	|Font size for the main title
...
text_color|color|black|Title and body text color
ratio1|float|0.5|Triangle pattern ratio 1
ratio2|float|0.5|Triangle pattern ratio 2
title_size|length|42pt|Title font size
text_size|length|24pt|Body text font size
is_last|bool|false|Set to true on the last slide to invert background
